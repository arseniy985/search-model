        ...
        <div class="grid gap-6 grid-cols-1 lg:grid-cols-5">
            <div class="lg:col-span-3">
                <div x-data="{
                    ...
                    images: ['{{ Vite::asset('public/storage/' . $product->image)}}'],
                    activeImage: null,
                    prev() {
                    ...
                    <div class="relative">
                        <template x-for="image in images">
                            <div x-show="activeImage === image" class="aspect-w-1 aspect-h-1">
                                <img :src="image" alt="" class="w-full h-[400px] object-contain mx-auto" />
                            </div>
                        </template>
            ...
            <div class="lg:col-span-2">
                ...
                @else
                    <a href="/login"
                        ...
                        Please sign in to place the product in your cart
                    </a>
                @endauth
